 ...
 * 
 * File: TruckEachCycleEnvRule.java
 * 
...
public class TruckEachCycleEnvRule extends EnvironmentRule {
  ...
  public TruckEachCycleEnvRule(String name, EnvironmentSimulator envSim) {
    super(name, envSim);
  }

  public void thenStateEffects() {
    truck.setX((truck.getX() + truck.getVx()
        * SimulationParameters.STEP_DURATION)
