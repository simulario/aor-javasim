...
import aors.gui.swing.ToolBar;

public class WebStartToolBarSimulation extends ToolBar {
  ...
  public WebStartToolBarSimulation(JFrame parent) {
    super((ActionListener) parent);
    this.parent = parent;

    this.setName(WebStartMenu.SIMULATION);

    this.setLayout(new FlowLayout(FlowLayout.LEFT));
    this.addButton(WebStartMenu.Item.RUN, WebStartMenu.Item.RUN_IMAGE);
    this.addButton(WebStartMenu.Item.STOP, WebStartMenu.Item.STOP_IMAGE);
