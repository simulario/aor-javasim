...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:aors="http://aor-simulation.org" version="1.0" exclude-result-prefixes="aors xsl">
...
-->
	...
	<xsl:template match="aors:SimulationModel" mode="documentNavigation" priority="-1">
		<li>
			<a>
				<xsl:attribute name="href"><xsl:call-template name="getId"><xsl:with-param name="prefix" select="'#'"/></xsl:call-template></xsl:attribute>
...
-->
	...
	<xsl:template name="createOptionalLink">
		...
		<xsl:choose>
			<xsl:when test="$node">
				<a>
					<xsl:attribute name="href"><xsl:call-template name="getId"><xsl:with-param name="node" select="$node"/><xsl:with-param name="prefix" select="'#'"/></xsl:call-template></xsl:attribute>
					<xsl:choose>
						<xsl:when test="$copy">
	...
	<!-- copyCode -->
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" name="copyCode">
	...
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" match="*" mode="copyCode" priority="-3"/>
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" match="aors:*" mode="copyCode" priority="-3">
		<dt>
	...
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" match="allex:*|aorsel:*" mode="copyCode" priority="-3">
		<dt>AORSEL:</dt>
		<dd>
			<xsl:call-template name="getFormattedCode"/>
		</dd>
	...
	<!-- getFormattedCode -->
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" name="getFormattedCode">
		<xsl:param name="code" select="."/>
	...
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" name="getFormattedCode_AORSEL">
		<xsl:param name="code"/>
		<xsl:apply-templates select="$code" mode="getFormattedCode_AORSEL"/>
	</xsl:template>
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" match="*" mode="getFormattedCode_AORSEL" priority="-3"/>
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" match="allex:*|aorsel:*" mode="getFormattedCode_AORSEL" priority="-3">
		<li>
			<code>
	...
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" name="getFormattedCode_Java">
		<xsl:param name="code"/>
	...
	<!-- mapToEntities -->
	<xsl:template xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" name="mapToEntities">
		<xsl:param name="code"/>
		<xsl:choose>
	...
	<xsl:template match="aors:InitialState/aors:GlobalVariable|aors:InitialState/aors:GridCells" mode="heading" priority="-4">
	...
	<xsl:template match="aors:InitialState/aors:*/aors:BeliefEntity" mode="classSectionHeading" priority="-4">
		<xsl:text>Belief Entities</xsl:text>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:*/aors:ReminderEvent|aors:InitialState/aors:*/aors:TimeEvent|aors:InitialState/aors:*/aors:PeriodicTimeEvent" mode="classSectionHeading" priority="-4">
		<xsl:text>Events</xsl:text>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:ExogenousEvent | aors:InitialState/aors:CausedEvent" mode="heading" priority="-4">
		<xsl:text>Caused and Exogenous Events</xsl:text>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:InitializationRule" mode="chapterHeading" priority="-4">
	...
	<xsl:template match="aors:InitialState/aors:InitializationRule" mode="navigationEntryTitle" priority="-4">
	...
	<!-- Globals -->
	<xsl:template match="aors:InitialState/aors:GlobalVariable|aors:InitialState/aors:GridCells" mode="chapterContent" priority="-4">
		<xsl:param name="content"/>
		<dl>
	...
	<xsl:template match="aors:InitialState/aors:GridCells/aors:Slot[1]" mode="update" priority="-4">
		<dt>
			<xsl:text>[GRID-CELL] (all cells)</xsl:text>
		</dt>
		<xsl:apply-templates select=".|following-sibling::aors:Slot" mode="update2"/>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:GridCells/aors:GridCell" mode="update" priority="-4">
		<dt>
			<xsl:value-of select="concat('[GRID-CELL] (',@x,',',@y,')')"/>
		</dt>
		<xsl:apply-templates select="aors:Slot" mode="update2"/>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:GridCells/aors:GridCellSet" mode="update" priority="-4">
		<dt>
	...
	<!-- aors:GridCells//Slot -->
	<xsl:template match="aors:InitialState/aors:GridCells/aors:*/aors:Slot|aors:InitialState/aors:GridCells/aors:Slot" mode="update2" priority="-4">
		<dd>
			<xsl:apply-templates select="." mode="slot"/>
		</dd>
	</xsl:template>
	<!-- Objects -->
	<xsl:template match="aors:InitialState/aors:Object|aors:InitialState/aors:Objects|aors:InitialState/aors:PhysicalObject|aors:InitialState/aors:PhysicalObjects|aors:InitialState/aors:Agent|aors:InitialState/aors:Agents|aors:InitialState/aors:PhysicalAgent|aors:InitialState/aors:PhysicalAgents|aors:InitialState/aors:Collection" mode="content" priority="-4">
		<xsl:param name="content"/>
		<xsl:apply-templates select="$content" mode="create">
			<xsl:sort select="count(aors:*) + count(@*)" order="descending" data-type="number"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:Object|aors:InitialState/aors:PhysicalObject|aors:InitialState/aors:Agent|aors:InitialState/aors:PhysicalAgent|aors:InitialState/aors:Collection" mode="create" priority="-4">
	...
	<xsl:template match="aors:InitialState/aors:Objects|aors:InitialState/aors:PhysicalObjects|aors:InitialState/aors:Agents|aors:InitialState/aors:PhysicalAgents" mode="create" priority="-4">
		<xsl:apply-templates select="." mode="class">
			<xsl:with-param name="headingElement" select="$section1Heading"/>
			<xsl:with-param name="kind" select="'objects'"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:Object|aors:InitialState/aors:Objects|aors:InitialState/aors:PhysicalObject|aors:InitialState/aors:PhysicalObjects|aors:InitialState/aors:Agent|aors:InitialState/aors:Agents|aors:InitialState/aors:PhysicalAgent|aors:InitialState/aors:PhysicalAgents|aors:InitialState/aors:Collection" mode="class" priority="-4">
	...
	<xsl:template match="aors:InitialState/aors:Object|aors:InitialState/aors:Objects|aors:InitialState/aors:PhysicalObject|aors:InitialState/aors:PhysicalObjects|aors:InitialState/aors:Agent|aors:InitialState/aors:Agents|aors:InitialState/aors:PhysicalAgent|aors:InitialState/aors:PhysicalAgents|aors:InitialState/aors:Collection" mode="classContent" priority="-4">
	...
	<xsl:template match="aors:InitialState/aors:*/aors:BeliefEntity" mode="classContent" priority="-4">
	...
	<xsl:template match="aors:InitialState/aors:*/aors:ReminderEvent|aors:InitialState/aors:*/aors:TimeEvent|aors:InitialState/aors:*/aors:PeriodicTimeEvent" mode="classContent" priority="-4">
	...
	<xsl:template match="aors:InitialState/aors:*/aors:BeliefEntity|aors:InitialState/aors:*/aors:ReminderEvent|aors:InitialState/aors:*/aors:TimeEvent|aors:InitialState/aors:*/aors:PeriodicTimeEvent" mode="classSectionContent" priority="-4">
		<xsl:param name="content"/>
		<ul>
	...
	<!-- EnvironmentEvents -->
	<xsl:template match="aors:InitialState/aors:ExogenousEvent|aors:InitialState/aors:CausedEvent" mode="content" priority="-4">
		<xsl:param name="content"/>
		<xsl:apply-templates select="$content" mode="create">
			<xsl:sort select="count(aors:*) + count(@*)" order="descending" data-type="number"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:ExogenousEvent|aors:InitialState/aors:CausedEvent" mode="create" priority="-4">
		<xsl:apply-templates select="." mode="class">
			<xsl:with-param name="headingElement" select="$section1Heading"/>
			<xsl:with-param name="kind" select="'object'"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template match="aors:InitialState/aors:ExogenousEvent|aors:InitialState/aors:CausedEvent" mode="classContent" priority="-4">
	...
	<!--###############-->
	<!-- WHEN -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:WHEN" mode="heading" priority="-5">
		<xsl:text>When</xsl:text>
	</xsl:template>
	<!-- FOR -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="@agentVariable|aors:FOR" mode="heading" priority="-5">
		<xsl:text>For</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:DO" mode="heading" priority="-5">
		<xsl:text>Do</xsl:text>
	</xsl:template>
	<!-- IF -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:IF" mode="heading" priority="-5">
		<xsl:text>If</xsl:text>
	</xsl:template>
	<!-- THEN and ELSE -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:THEN|aors:UPDATE-AGT|aors:UPDATE-ENV|aors:SCHEDULE-EVT|aors:CREATE-EVT|aors:InitializationRule/aors:UpdateObject|aors:InitializationRule/aors:UpdateObjects|aors:InitializationRule/aors:UpdateGridCell" mode="section2Heading" priority="-5">
		<xsl:text>Then</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ELSE" mode="heading" priority="-5">
		<xsl:text>Else</xsl:text>
	</xsl:template>
	<!-- UPDATE-AGT -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:Slot|aors:UPDATE-AGT/aors:SelfBeliefSlot" mode="heading" priority="-5">
		<xsl:text>Update Slots</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:UpdateComplexDataPropertyValue" mode="heading" priority="-5">
		<xsl:text>Update Complex Data Property</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:UpdateBeliefEntity" mode="heading" priority="-5">
		<xsl:text>Update Belief Entities</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:CreateBeliefEntity" mode="section3Heading" priority="-5">
		<xsl:text>Create Belief Entities</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:DestroyBeliefEntity" mode="heading" priority="-5">
		<xsl:text>Destroy Belief Entities</xsl:text>
	</xsl:template>
	<!-- UPDATE-ENV -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateObject|aors:UPDATE-ENV/aors:UpdateObjects|aors:UPDATE-ENV/aors:UpdateGridCell" mode="heading" priority="-5">
		<xsl:text>Update Objects</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateGlobalVariable|aors:UPDATE-ENV/aors:IncrementGlobalVariable|aors:UPDATE-ENV/aors:UpdateStatisticsVariable" mode="heading" priority="-5">
		<xsl:text>Update Global Variables</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:AddObjectToCollection|aors:UPDATE-ENV/aors:RemoveObjectFromCollection" mode="heading" priority="-5">
		<xsl:text>Update Collections</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create" mode="heading" priority="-5">
		<xsl:text>Create Objects</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:*/aors:BeliefEntity" mode="classSectionHeading" priority="-5">
		<xsl:text>Belief Entities</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:*/aors:ReminderEvent|aors:UPDATE-ENV/aors:Create/aors:*/aors:TimeEvent|aors:UPDATE-ENV/aors:Create/aors:*/aors:PeriodicTimeEvent" mode="classSectionHeading" priority="-5">
		<xsl:text>Events</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:DestroyObject|aors:UPDATE-ENV/aors:DestroyObjects" mode="heading" priority="-5">
		<xsl:text>Destroy Objects</xsl:text>
	</xsl:template>
	<!-- InitRule/Update -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:InitializationRule/aors:UpdateObject|aors:InitializationRule/aors:UpdateObjects|aors:InitializationRule/aors:UpdateGridCell" mode="heading" priority="-5">
		<xsl:text>Update Objects</xsl:text>
	</xsl:template>
	<!-- SCHEDULE-EVT -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:SCHEDULE-EVT" mode="section3Heading" priority="-5">
		<xsl:text>Schedule Event</xsl:text>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CreateDescription" mode="heading" priority="-5">
		<xsl:text>Create Descriptions</xsl:text>
	</xsl:template>
	<!-- CREATE-EVT -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CREATE-EVT" mode="section3Heading" priority="-5">
	...
	<!--###############-->
	<!-- WHEN -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:WHEN" mode="content" priority="-5">
		<xsl:call-template name="getOptionalValue">
			<xsl:with-param name="node">
				<xsl:choose>
					<xsl:when test="@eventType or @eventVariable">
						<xsl:text>[EVENT] </xsl:text>
						<xsl:call-template name="getOptionalValue">
							<xsl:with-param name="node" select="@eventVariable"/>
						</xsl:call-template>
						<xsl:text> : </xsl:text>
					...
					<xsl:when test="@messageType">
						...
						<xsl:call-template name="getOptionalValue">
							<xsl:with-param name="node" select="@messageVariable"/>
						</xsl:call-template>
						<xsl:text> : </xsl:text>
						<xsl:call-template name="createOptionalLink">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ActualPerceptionRule/aors:WHEN" mode="content" priority="-5">
		<xsl:call-template name="getOptionalValue">
			<xsl:with-param name="node">
				<xsl:choose>
	...
	<!-- FOR -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="@agentVariable|aors:FOR" mode="content" priority="-5">
		<xsl:param name="content"/>
		<ul class="for">
			<xsl:apply-templates select="$content" mode="for"/>
		</ul>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="@agentVariable" mode="for" priority="-5">
		<li>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CommunicationRule/aors:FOR|aors:AgentRule/aors:FOR" mode="for" priority="-5">
		<li>
			<xsl:call-template name="getOptionalValue">
				<xsl:with-param name="node">
					<xsl:choose>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:EnvironmentRule/aors:FOR|aors:InitializationRule/aors:FOR" mode="for" priority="-5">
		<li>
			<xsl:call-template name="getOptionalValue">
				<xsl:with-param name="node">
					<xsl:choose>
	...
	<!-- DO -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:DO" mode="content" priority="-5">
		<xsl:apply-templates select="aors:*" mode="doThenElse"/>
	</xsl:template>
	<!-- IF -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:IF" mode="content" priority="-5">
		<xsl:param name="content"/>
		<xsl:choose>
			<xsl:when test="count($content) &gt; 1 or string-length(normalize-space($content/text())) &gt; 60">
				<xsl:call-template name="hideContent">
					<xsl:with-param name="content">
						<xsl:call-template name="copyCode">
	...
	<!-- THEN -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:THEN" mode="content" priority="-5">
		<xsl:apply-templates select="aors:*" mode="doThenElse"/>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT|aors:UPDATE-ENV|aors:SCHEDULE-EVT|aors:CREATE-EVT" mode="section2Content" priority="-5">
		<xsl:param name="content"/>
		<xsl:apply-templates select="$content" mode="doThenElse"/>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:InitializationRule/aors:UpdateObject|aors:InitializationRule/aors:UpdateObjects|aors:InitializationRule/aors:UpdateGridCell" mode="section2Content" priority="-5">
		<xsl:param name="content"/>
	...
	<!-- ELSE -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ELSE" mode="content" priority="-5">
		<xsl:apply-templates select="aors:*" mode="doThenElse"/>
	</xsl:template>
	<!-- UPDATE-AGT -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT" mode="doThenElse" priority="-5">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:Slot|aors:UPDATE-AGT/aors:SelfBeliefSlot" mode="content" priority="-5">
		<xsl:param name="content"/>
		<ul class="update">
			<xsl:apply-templates select="$content" mode="update"/>
		</ul>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:Slot" mode="update" priority="-5">
		<li>
			<xsl:text>[SLOT] </xsl:text>
			<xsl:apply-templates select="." mode="slot"/>
		</li>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:SelfBeliefSlot" mode="update" priority="-5">
		<li>
			<xsl:text>[SB-SLOT] </xsl:text>
			<xsl:apply-templates select="." mode="slot"/>
		</li>
	</xsl:template>
	<!-- UPDATE-AGT/UpdateComplexDataProperty -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:UpdateComplexDataPropertyValue" mode="content" priority="-5">
		<xsl:param name="content"/>
		<ul class="update">
			<xsl:apply-templates select="." mode="complexDataProperty"/>
		</ul>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UpdateComplexDataPropertyValue" mode="complexDataProperty" priority="-5">
		<li>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UpdateComplexDataPropertyValue/aors:Argument" mode="complexDataProperty" priority="-5">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:UpdateBeliefEntity" mode="content" priority="-5">
		<xsl:param name="content"/>
		<dl class="update">
			<xsl:apply-templates select="$content" mode="update"/>
		</dl>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:UpdateBeliefEntity" mode="update" priority="-5">
		<dt>
	...
	<!-- UPDATE-AGT/UpdateBeliefEntity/BeliefSlot -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="UPDATE-AGT/aors:UpdateBeliefEntity/aors:BeliefSlot" mode="update" priority="-5">
		<dd>
			<xsl:apply-templates select="." mode="slot"/>
		</dd>
	</xsl:template>
	<!-- UPDATE-AGT/CreateBeliefEntity -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:CreateBeliefEntity" mode="section3Content" priority="-5">
		<xsl:param name="content"/>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:CreateBeliefEntity" mode="classContent" priority="-5">
		<xsl:apply-templates select="aors:BeliefSlot[1]" mode="classSection">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:DestroyBeliefEntity" mode="content" priority="-5">
		<xsl:param name="content"/>
		<ul class="destroy">
			<xsl:apply-templates select="$content" mode="destroy"/>
		</ul>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-AGT/aors:DestroyBeliefEntity" mode="destroy" priority="-5">
		<li>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV" mode="doThenElse" priority="-5">
		<xsl:variable name="updateObjects" select="aors:UpdateObject|aors:UpdateObjects|aors:UpdateGridCell|aors:UpdateGridCells"/>
		<xsl:apply-templates select="$updateObjects[1]" mode="section3">
			<xsl:with-param name="content" select="$updateObjects"/>
		</xsl:apply-templates>
		<xsl:variable name="updateGlobalVariables" select="aors:UpdateGlobalVariable|aors:IncrementGlobalVariable|aors:UpdateStatisticsVariable"/>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:InitializationRule/aors:UpdateObject|aors:InitializationRule/aors:UpdateObjects|aors:InitializationRule/aors:UpdateGridCell" mode="doThenElse" priority="-5">
		<xsl:param name="content"/>
		<dl class="update">
			<xsl:apply-templates select="$content" mode="update"/>
		</dl>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateObject|aors:UPDATE-ENV/aors:UpdateObjects|aors:UPDATE-ENV/aors:UpdateGridCell|aors:UPDATE-ENV/aors:UpdateGridCells|aors:InitializationRule/aors:UpdateObject|aors:InitializationRule/aors:UpdateObjects|aors:InitializationRule/aors:UpdateGridCell|aors:InitializationRule/aors:UpdateGridCells" mode="content" priority="-5">
		<xsl:param name="content"/>
		<dl class="update">
			<xsl:apply-templates select="$content" mode="update"/>
		</dl>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateObject|aors:InitializationRule/aors:UpdateObject" mode="update" priority="-5">
		<dt>
			<xsl:call-template name="getOptionalValue">
				<xsl:with-param name="node">
					<xsl:choose>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateObjects|aors:InitializationRule/aors:UpdateObjects" mode="update" priority="-5">
		<dt>
			<xsl:value-of select="concat('[OBJECTS] ',@objectVariable,' ∈ [')"/>
			<xsl:call-template name="getOptionalValue">
				<xsl:with-param name="node">
					<xsl:choose>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateGridCell|aors:InitializationRule/aors:UpdateGridCell" mode="update" priority="-5">
		<dt>
			<xsl:text>[GRID-CELL] (</xsl:text>
			<xsl:call-template name="getOptionalValue">
				<xsl:with-param name="node">
					<xsl:call-template name="hideContent">
						<xsl:with-param name="content">
			...
			<xsl:if test="@gridCellVariable">
				<xsl:value-of select="concat(' (variable: ',@gridCellVariable,')')"/>
			</xsl:if>
		</dt>
		<xsl:apply-templates select="aors:Slot|aors:Increment|aors:Decrement" mode="update"/>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateGridCells|aors:InitializationRule/aors:UpdateGridCells" mode="update" priority="-5">
		<dt>
			<xsl:text>[GRID-CELLS] (</xsl:text>
			<xsl:call-template name="getOptionalValue">
	...
	<!-- UPDATE-ENV//Slot -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:*/aors:Slot|aors:InitializationRule/aors:*/aors:Slot" mode="update" priority="-5">
		<dd>
			<xsl:apply-templates select="." mode="slot"/>
		</dd>
	</xsl:template>
	<!-- UPDATE-ENV/UpdateGloalVariable | UPDATE-ENV/IncrementGlobalVariable | UPDATE-ENV/UpdateStatistcsVariable -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateGlobalVariable|aors:UPDATE-ENV/aors:IncrementGlobalVariable|aors:UPDATE-ENV/aors:UpdateStatisticsVariable" mode="content" priority="-5">
		<xsl:param name="content"/>
		<ul class="update">
			<xsl:apply-templates select="$content" mode="update"/>
		</ul>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateGlobalVariable" mode="update" priority="-5">
		<li>
			<xsl:value-of select="concat('[GLOBAL] ',@name,' = ')"/>
			<xsl:call-template name="getOptionalValue">
				<xsl:with-param name="node">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:IncrementGlobalVariable" mode="update" priority="-5">
		<li>
			<xsl:value-of select="concat('[GLOBAL] ',@name,' + ',@value)"/>
		</li>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:UpdateStatisticsVariable" mode="update" priority="-5">
		<dt>
			<xsl:value-of select="concat('[STATISTICS] ',@variable,' = ')"/>
			<xsl:call-template name="hideContent">
				<xsl:with-param name="content">
					<xsl:call-template name="copyCode">
						<xsl:with-param name="code" select="aors:ValueExpr"/>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:AddObjectToCollection|aors:UPDATE-ENV/aors:RemoveObjectFromCollection" mode="content" priority="-5">
		<xsl:param name="content"/>
		<ul class="update">
			<xsl:apply-templates select="$content" mode="update"/>
		</ul>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:AddObjectToCollection" mode="update" priority="-5">
		<li>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:RemoveObjectFromCollection" mode="update" priority="-5">
		<li>
	...
	<!-- UPDATE-ENV/Create -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create" mode="content" priority="-5">
		<xsl:param name="content"/>
		<xsl:apply-templates select="$content" mode="create">
			<xsl:sort select="count(aors:*) + count(@*)" order="descending" data-type="number"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:Object|aors:UPDATE-ENV/aors:Create/aors:PhysicalObject|aors:UPDATE-ENV/aors:Create/aors:Agent|aors:UPDATE-ENV/aors:Create/aors:PhysicalAgent|aors:UPDATE-ENV/aors:Create/aors:Collection" mode="create" priority="-5">
		<xsl:apply-templates select="." mode="class">
			<xsl:with-param name="headingElement" select="$section4Heading"/>
			<xsl:with-param name="kind" select="'object'"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:Collection" mode="create" priority="-5">
		<xsl:apply-templates select="." mode="class">
			<xsl:with-param name="headingElement" select="$section4Heading"/>
			<xsl:with-param name="class" select="'parameterized'"/>
			<xsl:with-param name="kind" select="'object'"/>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:Objects|aors:UPDATE-ENV/aors:Create/aors:PhysicalObjects|aors:UPDATE-ENV/aors:Create/aors:Agents|aors:UPDATE-ENV/aors:Create/aors:PhysicalAgents" mode="create" priority="-5">
		<xsl:apply-templates select="." mode="class">
			<xsl:with-param name="headingElement" select="$section4Heading"/>
			<xsl:with-param name="kind" select="'objects'"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:*" mode="class" priority="-5">
		<xsl:param name="headingElement"/>
		<xsl:param name="class"/>
		<xsl:param name="kind"/>
		<xsl:apply-templates select="." mode="classBody">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:*" mode="classContent" priority="-5">
		<xsl:variable name="properties" select="@*[local-name()!='type' and local-name()!='id' and local-name()!='name' and local-name()!='addToCollection' and local-name()!='rangeStartID' and local-name()!='rangeEndID' and local-name()!='objectVariable' and local-name()!='creationLoopVar' and local-name()!='itemType']|aors:Slot"/>
		<xsl:apply-templates select="$properties[1]" mode="classSection">
			<xsl:with-param name="headingElement" select="$section5Heading"/>
			<xsl:with-param name="class" select="'properties'"/>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:*/aors:BeliefEntity" mode="classContent" priority="-5">
		<xsl:apply-templates select="aors:BeliefSlot[1]" mode="classSection">
			<xsl:with-param name="headingElement" select="$section5Heading"/>
			<xsl:with-param name="class" select="'properties'"/>
			<xsl:with-param name="content" select="aors:BeliefSlot"/>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:*/aors:ReminderEvent|aors:UPDATE-ENV/aors:Create/aors:*/aors:TimeEvent|aors:UPDATE-ENV/aors:Create/aors:*/aors:PeriodicTimeEvent" mode="classContent" priority="-5">
		<xsl:variable name="properties" select="@*[local-name()!='type' and local-name()!='id' and local-name()!='name']|aors:Slot"/>
		<xsl:apply-templates select="$properties[1]" mode="classSection">
			<xsl:with-param name="headingElement" select="$section5Heading"/>
			<xsl:with-param name="class" select="'properties'"/>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:Create/aors:*/aors:BeliefEntity|aors:UPDATE-ENV/aors:Create/aors:*/aors:ReminderEvent|aors:UPDATE-ENV/aors:Create/aors:*/aors:TimeEvent|aors:UPDATE-ENV/aors:Create/aors:*/aors:PeriodicTimeEvent" mode="classSectionContent" priority="-5">
		<xsl:param name="content"/>
		<ul>
			<xsl:apply-templates select="$content" mode="objectComponent"/>
		</ul>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:DestroyObject|aors:UPDATE-ENV/aors:DestroyObjects" mode="content" priority="-5">
		<xsl:param name="content"/>
		<ul class="destroy">
			<xsl:apply-templates select="$content" mode="destroy"/>
		</ul>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:DestroyObject" mode="destroy" priority="-5">
		<li>
			<xsl:text>[DESTROY</xsl:text>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:UPDATE-ENV/aors:DestroyObjects" mode="destroy" priority="-5">
		<li>
			<xsl:text>[DESTROY</xsl:text>
			<xsl:if test="@deferred = 'true'">
				<xsl:text> AT END</xsl:text>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Increment" mode="update" priority="-5">
		<dd>
			<xsl:value-of select="concat(@property,' + ',@value)"/>
		</dd>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Decrement" mode="update" priority="-5">
		<dd>
			<xsl:value-of select="concat(@property,' - ',@value)"/>
		</dd>
	</xsl:template>
	<!-- SCHEDULE-EVT -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:SCHEDULE-EVT" mode="doThenElse" priority="-5">
		<xsl:apply-templates select="." mode="section3"/>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:SCHEDULE-EVT" mode="section3Content" priority="-5">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ActionEventExpr|aors:OutMessageEventExpr|aors:ReminderEventExpr|aors:CausedEventExpr|aors:PerceptionEventExpr|aors:InMessageEventExpr|aors:ActivityStartEventExpr|aors:ActivityEndEventExpr" mode="classContent" priority="-5">
	...
	<!-- CREATE-EVT -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CREATE-EVT" mode="doThenElse" priority="-5">
		<xsl:apply-templates select="." mode="section3"/>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CREATE-EVT" mode="section3Content" priority="-5">
		<xsl:apply-templates select="." mode="class">
			<xsl:with-param name="headingElement" select="$section4Heading"/>
			<xsl:with-param name="kind" select="'object'"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CREATE-EVT" mode="classContent" priority="-5">
	...
	<!--### heading ###-->
	<!--###############-->
	<xsl:template match="aors:StopCondition|aors:Periodicity|aors:Condition" mode="classSectionHeading" priority="-6">
		<xsl:text>Conditions</xsl:text>
	</xsl:template>
	<!-- ################ -->
	<!-- ###  content ### -->
	<!-- ################ -->
	<xsl:template match="aors:Periodicity|aors:StopCondition|aors:Condition" mode="classSectionContent" priority="-6">
		<xsl:param name="content"/>
		<ul>
	...
	<xsl:template match="aors:Attribute|aors:SelfBeliefAttribute|aors:BeliefAttribute|aors:GridCellProperty" mode="property" priority="-7">
		<li>
			<xsl:choose>
	...
	<xsl:template match="aors:ReferenceProperty|aors:SelfBeliefReferenceProperty|aors:BeliefReferenceProperty" mode="property" priority="-7">
		<li>
			<xsl:if test="@isStatic = 'true'">
				<xsl:attribute name="class"><xsl:text>static</xsl:text></xsl:attribute>
			</xsl:if>
			<xsl:value-of select="@name"/>
			<xsl:if test="@upperMultiplicity">
				<xsl:choose>
	...
	<xsl:template match="aors:ComplexDataProperty|aors:EnumerationProperty" mode="property" priority="-7">
		<li>
			<xsl:if test="@isStatic = 'true'">
				<xsl:attribute name="class"><xsl:text>static</xsl:text></xsl:attribute>
			</xsl:if>
	...
	<!-- Slot -->
	<xsl:template match="aors:Slot|aors:BeliefSlot|aors:SelfBeliefSlot" mode="property" priority="-7">
		<li>
			<xsl:apply-templates select="." mode="slot"/>
		</li>
	</xsl:template>
	...
	<xsl:template match="aors:ReceiverIdRef" mode="property" priority="-7">
		<li>
			...
			<xsl:call-template name="hideContent">
				...
				<xsl:with-param name="heading" select="'Expression'"/>
				<xsl:with-param name="headingPrefix" select="concat('Code of ',local-name(..),'.receiverIdRef.')"/>
			</xsl:call-template>
		</li>
	</xsl:template>
	<!-- ReminderMsg -->
	...
	<xsl:template match="aors:PerceiverIdRef" mode="property" priority="-7">
		<li>
			...
			<xsl:call-template name="hideContent">
				...
				<xsl:with-param name="heading" select="'Expression'"/>
				<xsl:with-param name="headingPrefix" select="concat('Code of ',local-name(..),'.perceiverIdRef.')"/>
			</xsl:call-template>
		</li>
	</xsl:template>
	<!-- CorrelationValue -->
	<xsl:template match="aors:CorrelationValue" mode="property" priority="-7">
		<li>
			...
			<xsl:call-template name="hideContent">
				...
				<xsl:with-param name="heading" select="'Expression'"/>
				<xsl:with-param name="headingPrefix" select="concat('Code of ',local-name(..),'.correlationValue.')"/>
			</xsl:call-template>
		</li>
	</xsl:template>
	...
	<xsl:template match="aors:StartEventCorrelationProperty" mode="property" priority="-7">
		<li>
			...
			<xsl:call-template name="hideContent">
				...
				<xsl:with-param name="heading" select="'Expression'"/>
				<xsl:with-param name="headingPrefix" select="concat('Code of ',local-name(..),'.startEventCorrelationProperty.')"/>
			</xsl:call-template>
		</li>
	</xsl:template>
	...
	<xsl:template match="aors:EndEventCorrelationProperty" mode="property" priority="-7">
		<li>
			...
			<xsl:call-template name="hideContent">
				...
				<xsl:with-param name="heading" select="'Expression'"/>
				<xsl:with-param name="headingPrefix" select="concat('Code of ',local-name(..),'.endEventCorrelationProperty.')"/>
			</xsl:call-template>
		</li>
	</xsl:template>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Object|aors:PhysicalObject|aors:Agent|aors:PhysicalAgent" mode="classHeading" priority="-8">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Object|aors:PhysicalObject|aors:Agent|aors:PhysicalAgent" mode="headingName" priority="-8">
		<xsl:call-template name="getOptionalValue">
			<xsl:with-param name="node">
				<xsl:value-of select="@name"/>
				<xsl:choose>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Object|aors:PhysicalObject|aors:Agent|aors:PhysicalAgent" mode="headingType" priority="-8">
		<xsl:call-template name="createOptionalLink">
			<xsl:with-param name="node" select="key('EntityTypes',@type)"/>
			<xsl:with-param name="text" select="@type"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Create/aors:Collection" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',@type,'»')"/>
		</span>
		<span class="name">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Objects|aors:PhysicalObjects|aors:Agents|aors:PhysicalAgents" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',local-name(),'»')"/>
		</span>
		<span class="name">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Objects|aors:PhysicalObjects|aors:Agents|aors:PhysicalAgents" mode="headingName" priority="-8">
		<xsl:text>[</xsl:text>
		<xsl:call-template name="getOptionalValue">
			<xsl:with-param name="node">
				<xsl:choose>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Objects|aors:PhysicalObjects|aors:Agents|aors:PhysicalAgents" mode="headingType" priority="-8">
		<xsl:call-template name="createOptionalLink">
			<xsl:with-param name="node" select="key('EntityTypes',@type)"/>
			<xsl:with-param name="text" select="@type"/>
		</xsl:call-template>
	...
	<!-- BeliefEntity -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:BeliefEntity" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',local-name(),'»')"/>
		</span>
		<span class="name">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:BeliefEntity" mode="headingName" priority="-8">
		<xsl:call-template name="getOptionalValue">
			<xsl:with-param name="node">
				<xsl:value-of select="@name"/>
				<xsl:choose>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:BeliefEntity" mode="headingType" priority="-8">
		<xsl:call-template name="createOptionalLink">
			<xsl:with-param name="node" select="key('EntityTypes',@type)"/>
			<xsl:with-param name="text" select="@type"/>
		</xsl:call-template>
	...
	<!-- CreateBeliefEntity -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CreateBeliefEntity" mode="classHeading" priority="-8">
		<span class="stereotype small">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:TimeEvent|aors:PeriodicTimeEvent|aors:ReminderEvent" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',local-name(),'»')"/>
		</span>
		<span class="name">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ReminderEvent|aors:TimeEvent|aors:PeriodicTimeEvent" mode="headingName" priority="-8">
		<xsl:call-template name="getOptionalValue">
			<xsl:with-param name="node">
				<xsl:value-of select="@name"/>
				<xsl:if test="@id">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ReminderEvent|aors:TimeEvent|aors:PeriodicTimeEvent" mode="headingType" priority="-8">
		<xsl:call-template name="createOptionalLink">
			<xsl:with-param name="node" select="key('EntityTypes',@type)"/>
			<xsl:with-param name="text" select="@type"/>
		</xsl:call-template>
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ExogenousEvent | aors:CausedEvent" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',local-name(),'»')"/>
		</span>
		<span class="name">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ActionEventExpr" mode="classHeading" priority="-8">
		<span class="stereotype small">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CausedEventExpr|aors:PerceptionEventExpr" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',substring-before(local-name(),'Expr'),'»')"/>
		</span>
		<span class="name">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ReminderEventExpr" mode="classHeading" priority="-8">
		<span class="name">
			<xsl:text> ReminderEvent </xsl:text>
		</span>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:OutMessageEventExpr|aors:InMessageEventExpr" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',substring-before(local-name(),'Expr'),'»')"/>
		</span>
		<span class="name">
	...
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:ActivityStartEventExpr|aors:ActivityEndEventExpr" mode="classHeading" priority="-8">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',substring-before(local-name(),'Expr'),'»')"/>
		</span>
		<span class="name">
	...
	<!-- CREATE-EVT -->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:CREATE-EVT" mode="classHeading" priority="-8">
		<span class="stereotype small">
	...
	<!--### content ###-->
	<!--###############-->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:BeliefEntity|aors:ReminderEvent|aors:TimeEvent|aors:PeriodicTimeEvent" mode="objectComponent" priority="-8">
		<li>
			<a>
				<xsl:attribute name="href"><xsl:call-template name="getId"><xsl:with-param name="prefix" select="'#'"/></xsl:call-template></xsl:attribute>
				<xsl:apply-templates select="." mode="headingName"/>
	...
	<!--### content ###-->
	<!--###############-->
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Slot[@xsi:type = 'SimpleSlot' or substring-after(@xsi:type,':') = 'SimpleSlot' or @value]|aors:BeliefSlot[@xsi:type = 'SimpleSlot' or substring-after(@xsi:type,':') = 'SimpleSlot' or @value]|aors:SelfBeliefSlot[@xsi:type = 'SimpleSlot' or substring-after(@xsi:type,':') = 'SimpleSlot' or @value]" mode="slot" priority="-9">
		<xsl:value-of select="concat(@property,' = ',@value)"/>
	</xsl:template>
	<xsl:template xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:Slot[@xsi:type = 'OpaqueExprSlot' or substring-after(@xsi:type,':') = 'OpaqueExprSlot' or aors:ValueExpr]|aors:BeliefSlot[@xsi:type = 'OpaqueExprSlot' or substring-after(@xsi:type,':') = 'OpaqueExprSlot' or aors:ValueExpr]|aors:SelfBeliefSlot[@xsi:type = 'OpaqueExprSlot' or substring-after(@xsi:type,':') = 'OpaqueExprSlot' or aors:ValueExpr]" mode="slot" priority="-9">
	...
	<!--### local macros ###-->
	<!--####################-->
	<xsl:template xmlns:html="http://www.w3.org/1999/xhtml" xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" name="getModelTitle">
		<xsl:choose>
	...
	<!--### basic structure ###-->
	<!--#######################-->
	<xsl:template xmlns:html="http://www.w3.org/1999/xhtml" xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="*" priority="-10"/>
	<xsl:template xmlns:html="http://www.w3.org/1999/xhtml" xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="/" priority="-10">
		<html>
			<head>
	...
	<xsl:template xmlns:html="http://www.w3.org/1999/xhtml" xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="/" mode="head" priority="-10">
		<title>
			<xsl:call-template name="getModelTitle"/>
		</title>
		<meta http-equiv="Content-Type" content="application/xml; charset=UTF-8"/>
		<link rel="stylesheet">
			<xsl:attribute name="href"><xsl:choose><xsl:when test="aors:SimulationScenario/@simulationManagerDirectory"><xsl:variable name="simulatorDir" select="aors:SimulationScenario/@simulationManagerDirectory"/><xsl:value-of select="$simulatorDir"/><xsl:if test="translate(substring($simulatorDir,string-length($simulatorDir)),'\','/') != '/'"><xsl:text>/</xsl:text></xsl:if></xsl:when><xsl:otherwise><xsl:text>../</xsl:text></xsl:otherwise></xsl:choose><xsl:text>ext/prettyPrint/css/prettyprint.css</xsl:text></xsl:attribute>
		</link>
	</xsl:template>
	<!--##########################-->
	<!--### documentNavigation ###-->
	...
	<!--### documentBody ###-->
	<!--####################-->
	<xsl:template xmlns:html="http://www.w3.org/1999/xhtml" xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="*" mode="documentBody" priority="-10"/>
	<xsl:template xmlns:html="http://www.w3.org/1999/xhtml" xmlns:allex="http://aor-simulation.org/allex" xmlns:aorsel="http://aor-simulation.org/aorsel" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" match="aors:SimulationModel" mode="documentBody" priority="-10">
	...
	<!--### heading ###-->
	<!--###############-->
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="chapterHeading" priority="-12">
		<xsl:text>Agent Rules</xsl:text>
	</xsl:template>
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="heading" priority="-12">
		<xsl:value-of select="concat(../@name,'::',@name)"/>
	</xsl:template>
	<!--##################-->
	<!--### navigation ###-->
	<!--##################-->
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="navigation" priority="-12">
		<xsl:param name="content"/>
		<li>
			<a>
				<xsl:attribute name="href"><xsl:call-template name="getId"><xsl:with-param name="prefix" select="'#'"/></xsl:call-template></xsl:attribute>
	...
	<!--###  content ###-->
	<!--################-->
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="chapterContent" priority="-12">
		<xsl:param name="content"/>
		<xsl:apply-templates select="$content" mode="section1"/>
	</xsl:template>
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="section1" priority="-12">
		<xsl:param name="class"/>
		<xsl:apply-templates select="." mode="section1Body">
			<xsl:with-param name="class">
				<xsl:text> rule</xsl:text>
	...
	<xsl:template match="aors:AgentRule|aors:CommunicationRule" mode="content" priority="-12">
		...
		<xsl:variable name="then" select="aors:UPDATE-AGT|aors:SCHEDULE-EVT"/>
		<xsl:apply-templates select="$then[1]" mode="section2">
			<xsl:with-param name="content" select="$then"/>
			<xsl:with-param name="class" select="'then'"/>
		</xsl:apply-templates>
	...
	<xsl:template match="aors:ActualPerceptionEventType|aors:TimeEventType|aors:PeriodicTimeEventType" mode="classSectionHeading" priority="-13">
		<xsl:text>Event Types</xsl:text>
	</xsl:template>
	<xsl:template match="aors:BeliefEntityType|aors:ActualPerceptionEventType|aors:TimeEventType|aors:PeriodicTimeEventType" mode="classHeading" priority="-13">
		<span class="stereotype small">
			<xsl:value-of select="concat('«',local-name(),'»')"/>
		</span>
		<span class="name">
	...
	<!-- AgentRules -->
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="classSectionHeading" priority="-13">
	...
	<!-- BeliefEntityTypes and InternalEventTypes -->
	<xsl:template match="aors:BeliefEntityType|aors:ActualPerceptionEventType|aors:TimeEventType|aors:PeriodicTimeEventType" mode="navigation" priority="-13">
		<xsl:apply-templates select="." mode="navigationEntry"/>
	</xsl:template>
	<xsl:template match="aors:BeliefEntityType|aors:ActualPerceptionEventType|aors:TimeEventType|aors:PeriodicTimeEventType" mode="navigationEntryTitle" priority="-13">
		<xsl:value-of select="concat(../@name,'::',@name)"/>
	</xsl:template>
	<!-- ################ -->
	<!-- ###  content ### -->
	...
	<xsl:template match="aors:EntityTypes/*|aors:BeliefEntityType|aors:ActualPerceptionEventType|aors:TimeEventType|aors:PeriodicTimeEventType" mode="classContent" priority="-13">
	...
	<xsl:template match="aors:BeliefEntityType|aors:ActualPerceptionEventType|aors:TimeEventType|aors:PeriodicTimeEventType|aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="classSectionContent" priority="-13">
		<xsl:param name="content"/>
		<ul>
			<xsl:apply-templates select="$content" mode="entityTypeComponent"/>
		</ul>
	</xsl:template>
	<xsl:template match="aors:BeliefEntityType|aors:ActualPerceptionEventType|aors:TimeEventType|aors:PeriodicTimeEventType|aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="entityTypeComponent" priority="-13">
		<li>
			<a>
				<xsl:attribute name="href"><xsl:call-template name="getId"><xsl:with-param name="prefix" select="'#'"/></xsl:call-template></xsl:attribute>
				<xsl:value-of select="@name"/>
	...
	<!--### heading ###-->
	<!--###############-->
	<xsl:template match="aors:Function|aors:GlobalFunction|aors:GridCellFunction|aors:DefaultConstructor" mode="classSectionHeading" priority="-14">
	...
	<!-- ###  content ### -->
	<!-- ################ -->
	<xsl:template match="aors:Function|aors:SubjectiveFunction|aors:GlobalFunction|aors:GridCellFunction|aors:DefaultConstructor" mode="classSectionContent" priority="-14">
		<xsl:param name="content"/>
		<ul>
	...
	<xsl:template match="aors:Function|aors:SubjectiveFunction|aors:GlobalFunction|aors:GridCellFunction" mode="function" priority="-14">
		<li>
			<xsl:call-template name="hideContent">
				<xsl:with-param name="content">
					<xsl:apply-templates select="aors:documentation" mode="content"/>
	...
	<xsl:template match="aors:Enumeration|aors:ComplexDataType" mode="navigationEntryTitle" priority="-17">
		<xsl:value-of select="@name"/>
	</xsl:template>
	<!-- ################ -->
	<!-- ###  content ### -->
			...
			<td class="left">
				<xsl:call-template name="getOptionalValue">
					<xsl:with-param name="node">
						...
						<xsl:if test="aors:ValueExpr">
							<xsl:choose>
								<xsl:when test="count(aors:ValueExpr) &gt; 1 or string-length(normalize-space(aors:ValueExpr/text())) &gt; 30">
									<xsl:call-template name="hideContent">
										<xsl:with-param name="content">
											<xsl:call-template name="copyCode">
												<xsl:with-param name="code" select="aors:ValueExpr"/>
	...
	<xsl:template match="aors:SimulationParameterDeclaration" mode="simulationParameterDeclaration" priority="-20">
		<tr>
			<td>
				<xsl:value-of select="@name"/>
			</td>
	...
	<!-- #################### -->
	<!-- getNameList -->
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" name="getNameList">
		<xsl:apply-templates select="preceding-sibling::dc:*" mode="getNameList">
			<xsl:sort select="position()" order="descending"/>
		</xsl:apply-templates>
	</xsl:template>
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="*" mode="getNameList" priority="-22"/>
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="dc:*" mode="getNameList" priority="-22">
		<xsl:value-of select="name()"/>
		<xsl:text> </xsl:text>
	</xsl:template>
	<!--###############-->
	<!--### heading ###-->
	<!--###############-->
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="aors:documentation" mode="heading" priority="-22">
		<xsl:text>Documentation</xsl:text>
	</xsl:template>
	<!--##################-->
	<!--### navigation ###-->
	<!--##################-->
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="aors:documentation" mode="navigation" priority="-22">
		<xsl:apply-templates select="." mode="navigationEntry"/>
	</xsl:template>
	<!-- ################ -->
	<!-- ###  content ### -->
	<!-- ################ -->
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="aors:documentation" mode="content" priority="-22">
	...
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="aors:*" mode="documentation" priority="-22"/>
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="aors:informationModelDiagram|aors:processModelDiagram" mode="documentation" priority="-22">
		<dt>
	...
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="aors:description" mode="documentation" priority="-22">
	...
	<xsl:template xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:html="http://www.w3.org/1999/xhtml" match="dc:*" mode="documentation" priority="-22">
		<xsl:variable name="prevNames">
			<xsl:call-template name="getNameList"/>
		</xsl:variable>
		<xsl:if test="substring-before($prevNames,' ') != name()">
	...
	<xsl:template name="createSection">
		...
		<div>
			...
			<xsl:attribute name="class"><xsl:text>section</xsl:text><xsl:if test="$class"><xsl:value-of select="concat(' ',$class)"/></xsl:if></xsl:attribute>
			<xsl:element name="{$headingElement}">
				<xsl:attribute name="class"><xsl:text>heading</xsl:text></xsl:attribute>
				<xsl:copy-of select="$heading"/>
			</xsl:element>
			<div class="content">
				<xsl:copy-of select="$content"/>
