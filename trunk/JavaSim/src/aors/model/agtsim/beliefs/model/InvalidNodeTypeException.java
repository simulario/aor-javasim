...
/**
 * Exception type thrown when an invalid node type is detected.
 * 
...
public class InvalidNodeTypeException extends Exception {
  /**
   * Define the ID of the exception type.
   */
  private static final long serialVersionUID = 4752867538019033241L;

  /**
   * Create an InvalidNodeTypeException exception.
   * 
   * @param message
