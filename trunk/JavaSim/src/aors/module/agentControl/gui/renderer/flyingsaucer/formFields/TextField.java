...
class TextField extends InputField<JTextField> implements Receiver {
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    this.mediator.addReceiver(getAttribute(Receiver.RECEIVER_ATTRIBUTE), this,
			this.getValue());
    this.mediator.addSender(getAttribute(Sender.SENDER_ATTRIBUTE), this);
		this.getComponent().addActionListener(new ActionListener() {

      @Override
      public void actionPerformed(ActionEvent e) {
        TextField.this.mediator.propertyChange(new PropertyChangeEvent(
					TextField.this, getAttribute(Receiver.RECEIVER_ATTRIBUTE), null,
