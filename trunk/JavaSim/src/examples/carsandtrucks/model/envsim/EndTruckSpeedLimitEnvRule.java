 ...
 * 
 * File: EndTruckSpeedLimitEnvRule.java
 * 
...
public class EndTruckSpeedLimitEnvRule extends EnvironmentRule {
   ...
   * @param envSim
   */
  public EndTruckSpeedLimitEnvRule(String name, EnvironmentSimulator envSim) {
    super(name, envSim);
  }
  ...
  public ArrayList<EnvironmentEvent> thenResultingEvents() {
    ...
    TruckSpeedLimitEndPercEvt truckSpeedLimitEndPercEvt = new TruckSpeedLimitEndPercEvt(
        eachCycle.getOccurrenceTime() + 1, perceiver);

    result.add(truckSpeedLimitEndPercEvt);
    return result;
  }
