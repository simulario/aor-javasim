...
public class SpeedUpEnvRule extends EnvironmentRule {
  ...
  /**
   * &lt;TriggeringAtomicEventExpr eventType="SpeedUp"
   * eventVariable="speedUpActEvt"/&gt;
   */
  private SpeedUp speedUpActEvt;

  /**
   * &lt;AgentVariableDeclaration type="Car" variable="car"&gt;
   */
   ...
   * @param envSim
   */
  public SpeedUpEnvRule(String name, EnvironmentSimulator envSim) {
    super(name, envSim);
  }
  ...
  public ArrayList<EnvironmentEvent> execute() {
    ...
    this.car = (CarAgentObject) getEnvironmentSimulator().getPhysAgentById(
        this.speedUpActEvt.getActorIdRef(), CarAgentObject.class);
  ...
  public void setTriggeringEvent(AtomicEvent atomicEvent) {
    this.speedUpActEvt = (SpeedUp) atomicEvent;
  ...
  public void thenStateEffects() {
    this.car.setVx(this.speedUpActEvt.getVelocity());
