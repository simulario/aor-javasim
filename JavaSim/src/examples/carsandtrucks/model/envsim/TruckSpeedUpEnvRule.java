 ...
 * @version $Revision$
 */
public class TruckSpeedUpEnvRule extends EnvironmentRule {

  private TruckSpeedUp truckSpeedUp;
   ...
   * @param envSim
   */
  public TruckSpeedUpEnvRule(String name, EnvironmentSimulator envSim) {
    super(name, envSim);;
  }
  ...
  public ArrayList<EnvironmentEvent> execute() {
    ...
    this.truck = (TruckAgentObject) getEnvironmentSimulator().getPhysAgentById(
        this.truckSpeedUp.getActorIdRef());
  ...
  public void setTriggeringEvent(AtomicEvent event) {
    this.truckSpeedUp = (TruckSpeedUp) event;

  }

  public void thenStateEffects() {
    this.truck.setVx(this.truckSpeedUp.getVelocity());
