...
public class StartSpeedLimitEnvRule extends EnvironmentRule {
  ...
  public ArrayList<EnvironmentEvent> thenResultingEvents() {
    ...
    perceiver = car.getId();
    SpeedLimitStartPercEvt speedLimitStartPercEvt = new SpeedLimitStartPercEvt(
        eachCycle.getOccurrenceTime(), perceiver);
    speedLimitStartPercEvt.setAdmMaxVel(this.sign.getAdmMaxVel());
    result.add(speedLimitStartPercEvt);
    return result;
  }
