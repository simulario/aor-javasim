 ...
 */
public class CarSlowDownEnvRule extends EnvironmentRule {
   ...
   * @param envSim
   */
  public CarSlowDownEnvRule(String name, EnvironmentSimulator envSim) {
    super(name, envSim);
  }
  ...
  public void setTriggeringEvent(AtomicEvent event) {
    this.slowDown = (SlowDown) event;
  }

  public void thenStateEffects() {
    this.car.setVx(this.slowDown.getVelocity());
  }
