 ...
 * 
 * File: TruckSlowDownEnvRule.java
 * 
...
public class TruckSlowDownEnvRule extends EnvironmentRule {
  ...
  private TruckSlowDown truckSlowDown;
   ...
   * @param envSim
   */
  public TruckSlowDownEnvRule(String name, EnvironmentSimulator envSim) {
    super(name, envSim);
  }
  ...
  public ArrayList<EnvironmentEvent> execute() {
    ...
    this.truck = (TruckAgentObject) getEnvironmentSimulator().getPhysAgentById(
        this.truckSlowDown.getActorIdRef());

    if (this.truck != null && condition()) {
      thenStateEffects();
  ...
  public String getTriggeringEventType() {
    return "TruckSlowDown";
  }

  public void setTriggeringEvent(AtomicEvent event) {
    this.truckSlowDown = (TruckSlowDown) event;
  }

  public void thenStateEffects() {
    this.truck.setVx(this.truckSlowDown.getVelocity());
  }
