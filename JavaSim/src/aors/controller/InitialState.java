...
public class InitialState {
  ...
  /**
   * Gets the value for the statistic variable which have given name and have to compute first
   * (e.g. for Source/ValueExpr)
   * 
   * @param statisticVarName - the name of the statistic variable
