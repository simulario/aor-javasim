...
import aors.module.physics2d.util.IntervalList2D;
...
public class Simulator2DGrid extends PhysicsSimulator {
  ...
  private IntervalList2D intervalList;
  ...
  public Simulator2DGrid(SimulationParameters simParams,
    ...
    intervalList = new IntervalList2D(getPhysicals(), spaceModel);
 ...
 /* private void processCollisions(List<Collision1D> collisions) {
   ...
   */
  private void processPerceptions(List<Perception> perceptions) {
    for (Perception perception : perceptions) {
      double distance = perception.getDistance2DGrid();
      double angle = perception.getAngle2D();
  ...
  public void objektInitEvent(ObjektInitEvent objInitEvent) {
    if (objInitEvent.getSource() instanceof Physical) {
      intervalList.addGrid((Physical) (objInitEvent.getSource()));
    }
  }
