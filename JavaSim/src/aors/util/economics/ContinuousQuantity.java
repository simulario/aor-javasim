 ...
 * an instance of ContinuousQuantity while setting its type property to that type.
 * 
...
public class ContinuousQuantity extends Object{
  ...
  /**
   * Add an amount of this type of continuous quantity. A RuntimeException will be 
  ...
  /**
   * Remove an amount of this type of continuous quantity. If quantity is smaller
   * than amount, quantity is set to 0. Returns the amount successfully 
