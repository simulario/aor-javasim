...
<xsl:transform version="2.0" xmlns:aorsl="http://aor-simulation.org" xmlns:fn="http://www.w3.org/2005/xpath-functions"
  ...
  <xsl:template name="createPhysicalObjects">
    <xsl:apply-templates select="aorsl:SimulationScenario/aorsl:SimulationModel/aorsl:EntityTypes/aorsl:PhysicalObjectType"
  ...
  <xsl:template name="createObjects">
    <xsl:apply-templates select="aorsl:SimulationScenario/aorsl:SimulationModel/aorsl:EntityTypes/aorsl:ObjectType"
