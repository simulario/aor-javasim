...
<xsl:stylesheet
	...
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="chapterHeading">
		<xsl:text>Agent Rules</xsl:text>
	</xsl:template>

	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="heading">
	...
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="navigation">
	...
	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="chapterContent">
		<xsl:param name="content"/>
		<xsl:apply-templates select="$content" mode="section1"/>
	</xsl:template>

	<xsl:template match="aors:ActualPerceptionRule|aors:AgentRule|aors:CommunicationRule" mode="section1">
	...
	<xsl:template match="aors:AgentRule|aors:CommunicationRule" mode="content">
