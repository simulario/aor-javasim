 ...
 * @version $Revision$
 */
public class InternalEvent extends AtomicEvent {

  /**
   * 
   * Create a new {@code InternalEvent}.
   * 
   */
   ...
   * @param id
   */
  protected InternalEvent(long id, long occurrenceTime) {
   ...
   */
  protected InternalEvent(long occurrenceTime) {
