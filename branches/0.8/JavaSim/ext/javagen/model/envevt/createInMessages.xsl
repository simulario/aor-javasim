...
<xsl:stylesheet version="2.0" xmlns:aorsl="http://aor-simulation.org" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:java="http://www.sun.com/java"
  ...
  <!--creates class-->
  <xsl:template match="aorsl:InMessageEventType" mode="createInMessages.createInMessage">
  ...
  <!-- constructors -->
  <xsl:template match="aorsl:InMessageEventType" mode="createInMessages.constructors">
    <xsl:param name="indent" required="yes" as="xs:integer"/>
